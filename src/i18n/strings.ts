export const strings = {
  ...
  child: {
    ...
    celebrationBody: "Wszystkie zadania zrobione. Nagroda została odkryta w całości.",
    celebrationViewRewardButton: "Zobacz nagrodę",
    celebrationParentButton: "Wróć do rodzica",
