export const strings = {
  ...
  addGoal: {
    ...
    rewardTemplatesTitle: "Szybkie pomysły",
    rewardTemplates: ["Wyjście do kina", "Nowa zabawka", "Lody", "Czas na grę", "Wycieczka", "Wspólne pieczenie"],
    rewardTemplateLabel: (rewardName: string) => `Ustaw nagrodę: ${rewardName}`,
  ...
  child: {
    ...
    celebrationTitle: (childName: string) => `Brawo, ${childName}!`,
    celebrationBody: "Nagroda odkryta! Świetna robota!",
    celebrationViewGoalsButton: "Pokaż cele",
    celebrationAddGoalButton: "Dodaj nowy cel",
  ...
  settings: {
    ...
    dataBackupSectionTitle: "DANE I KOPIA ZAPASOWA",
    exportData: "Eksportuj dane",
    exportDataDesc: "Zapisz cele i ustawienia do pliku JSON.",
